...
namespace Screens_01
{
    ...
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<string> Occupations { get; set; }
        public ObservableCollection<string> Hobbies { get; set; }

        public MainViewModel()
        {
            PersonDatabase.EnsureDatabase();
            LoadAllPeople();

            Occupations = new ObservableCollection<string>(PersonDatabase.GetAllOccupations());
            Hobbies = new ObservableCollection<string>(PersonDatabase.GetAllHobbies());
